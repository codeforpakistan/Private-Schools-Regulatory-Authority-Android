...
public class MyFirebaseMessageReceived extends FirebaseMessagingService {
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            saveToDb(complain_id, statusTitle, complainTypeTitle, date,complainDetail,notificationId);
    ...
    private void saveToDb(String complain_id, String statusTitle, String complainTypeTitle, String date, String complainDetail,int notificationId) {
        ...
        notificationModule = new ComplainData(complain_id, statusTitle, complainTypeTitle,date,complainDetail,notificationId);
